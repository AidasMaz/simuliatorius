...
public class TweeningPhone : MonoBehaviour
{
    ...
    public void QuickMoveFromRight()
    {
        ...
        Phone.gameObject.GetComponent<RectTransform>().localPosition = new Vector3(550, 0, 0);
        LeanTween.moveLocal(Phone.gameObject, new Vector3(250, 0, 0), 0.7f);
    }

    public void QuickMoveToRight()
    {
        OriginalPhonePos = Phone.gameObject.GetComponent<RectTransform>().localPosition;
        LeanTween.moveLocal(Phone.gameObject, new Vector3(550, 0, 0), 0.8f);
    }
}
